...
-- This tails function does not behave exactly like the one in Haskell's Data.List.
-- In fact, it is only useful as a building block in the flattening function.
...
-- What we would like to do, is given a tensor T<d_1..d_r>,
-- return T'<i> = T< i// prod [d_2..d_r], i// prod[d3..d_r], .., i//d_r, i % d_r>
